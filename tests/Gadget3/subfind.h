...
#ifdef LT_ADD_GAL_TO_SUB
extern int  bc_use_index[12];
extern char bc_name[12][2];
#endif
...
void subfind_determine_sub_halo_properties(struct unbind_data *ud, int num, double *mass, 
					   ...
					   double *vmax, double *vmaxrad, double *spin, MyIDType *mostboundid, 
                                           ...
                                           double *lum, double *lumatt, double *lumobs, double *dust, 
                                           double *meanage, double *meanzstar, double *SFRgas);
#else
void subfind_determine_sub_halo_properties(struct unbind_data *ud, int num, double *mass, 
					   double *pos, double *vel, double *cm, double *veldisp,
...
extern int Nbiggroups;
extern int TotNbiggroups;
#endif
...
#endif
#ifdef LT_ADD_GAL_TO_SUB
  double SubLum[LT_ADD_GAL_TO_SUB];
#ifdef DUSTATT
  double SubLumAtt[LT_ADD_GAL_TO_SUB];
  double DustProfile[DUSTATT];
#endif
#ifdef OBSERVER_FRAME
  double SubLumObs[LT_ADD_GAL_TO_SUB];
#endif
  double SubMeanAge;
  double SubMeanZStar;
  double SubSFR;
